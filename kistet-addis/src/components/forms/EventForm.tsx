...
import { createEvent, supabase, uploadImage } from '../../lib/supabase';
  ...
  const onSubmit = async (data: EventFormValues) => {
    ...
    try {
      ...
      await createEvent({
        ...
        organizer_id: user.id, // Strictly use organizer_id
      });
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 max-w-5xl mx-auto pb-20">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {errors.ticket_price && <p className="text-red-500 text-xs font-bold mt-1 ml-1">{errors.ticket_price.message}</p>}
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Right Section: Location & Submission */}
