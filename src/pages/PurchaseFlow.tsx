...
const PurchaseFlow: React.FC = () => {
  ...
  const handleDownloadPDF = () => {
    if (!createdTicket || createdTicket.status !== 'approved') return;
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[ 
                    ...
                    >
                      <div className={`w-14 h-14 ${method.color} rounded-2xl flex items-center justify-center text-white shrink-0 shadow-lg shadow-${method.color.split('-')[1]}-100`}>
